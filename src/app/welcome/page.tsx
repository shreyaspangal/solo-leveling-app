  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-6 py-16">
      <div className="w-full max-w-lg text-center">
        ...
        <ul className="mt-8 space-y-2 text-left text-sm text-zinc-600 dark:text-zinc-400">
        ...
        <Link
          href="/rules"
          className="mt-10 inline-flex h-12 w-full items-center justify-center rounded-full bg-foreground px-6 font-medium text-background transition-colors hover:bg-[#383838] dark:hover:bg-[#ccc]"
        >
          Get Started
        </Link>
      </div>
